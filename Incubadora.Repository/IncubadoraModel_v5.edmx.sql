...
-- --------------------------------------------------
-- Date Created: 08/02/2022 15:21:54
-- Generated from EDMX file: C:\Users\DiegoGo Ar\source\repos\Incubadora\Incubadora.Repository\IncubadoraModel.edmx
-- --------------------------------------------------
...
GO
IF OBJECT_ID(N'[dbo].[FK_EmprendimientoEstadia_Status]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[EmprendimientoEstadia] DROP CONSTRAINT [FK_EmprendimientoEstadia_Status];
GO
IF OBJECT_ID(N'[dbo].[fk_estado_pais]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[CatEstados] DROP CONSTRAINT [fk_estado_pais];
GO
IF OBJECT_ID(N'[dbo].[FK_Estudiantes_CatCarreras]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[Estudiantes] DROP CONSTRAINT [FK_Estudiantes_CatCarreras];
GO
IF OBJECT_ID(N'[dbo].[FK_Estudiantes_CatGrupos]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[Estudiantes] DROP CONSTRAINT [FK_Estudiantes_CatGrupos];
GO
IF OBJECT_ID(N'[dbo].[FK_Estudiantes_CatPeriodoEstadia1]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[Estudiantes] DROP CONSTRAINT [FK_Estudiantes_CatPeriodoEstadia1];
GO
IF OBJECT_ID(N'[dbo].[FK_Estudiantes_EmprendimientoEstadia]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[Estudiantes] DROP CONSTRAINT [FK_Estudiantes_EmprendimientoEstadia];
GO
IF OBJECT_ID(N'[dbo].[FK_Estudiantes_Status]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[Estudiantes] DROP CONSTRAINT [FK_Estudiantes_Status];
GO
IF OBJECT_ID(N'[dbo].[FK_Estudiantes_Telefonos]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[Estudiantes] DROP CONSTRAINT [FK_Estudiantes_Telefonos];
GO
...
GO
IF OBJECT_ID(N'[dbo].[CatGrupos]', 'U') IS NOT NULL
    DROP TABLE [dbo].[CatGrupos];
GO
...
GO
IF OBJECT_ID(N'[dbo].[CatPeriodoEstadia]', 'U') IS NOT NULL
    DROP TABLE [dbo].[CatPeriodoEstadia];
GO
...
GO
IF OBJECT_ID(N'[dbo].[EmprendimientoEstadia]', 'U') IS NOT NULL
    DROP TABLE [dbo].[EmprendimientoEstadia];
GO
...
-- Creating table 'CatGrupos'
CREATE TABLE [dbo].[CatGrupos] (
    [Id] nvarchar(450)  NOT NULL,
    [StrValor] nvarchar(256)  NULL
);
GO

-- Creating table 'CatPeriodoEstadia'
CREATE TABLE [dbo].[CatPeriodoEstadia] (
    [Id] nvarchar(450)  NOT NULL,
    [StrValor] nvarchar(256)  NULL
);
GO

-- Creating table 'EmprendimientoEstadia'
CREATE TABLE [dbo].[EmprendimientoEstadia] (
    [Id] nvarchar(450)  NOT NULL,
    [StrValor] nvarchar(256)  NULL,
    [StrDescripcion] varchar(255)  NULL,
    [IdStatus] int  NULL
...
CREATE TABLE [dbo].[Estudiantes] (
    [Id] nvarchar(450)  NOT NULL,
    [StrNombre] nvarchar(256)  NULL,
    [StrApellidoPaterno] nvarchar(256)  NULL,
    [StrApellidoMaterno] nvarchar(256)  NULL,
    [FechaNacimiento] datetime  NULL,
    [IdTelefono] nvarchar(450)  NULL,
    [IdCarrera] nvarchar(450)  NULL,
    [IdCatGrupo] nvarchar(450)  NULL,
    [StrGrupoDescripcion] nvarchar(256)  NULL,
    [IdCatPeriodoEstadia] nvarchar(450)  NULL,
    [IdEmprendimientoEstadia] nvarchar(450)  NULL,
    [IdStatus] int  NULL
);
GO
...
-- Creating primary key on [Id] in table 'CatGrupos'
ALTER TABLE [dbo].[CatGrupos]
ADD CONSTRAINT [PK_CatGrupos]
    PRIMARY KEY CLUSTERED ([Id] ASC);
GO

-- Creating primary key on [Id] in table 'CatPeriodoEstadia'
ALTER TABLE [dbo].[CatPeriodoEstadia]
ADD CONSTRAINT [PK_CatPeriodoEstadia]
    PRIMARY KEY CLUSTERED ([Id] ASC);
GO

-- Creating primary key on [Id] in table 'EmprendimientoEstadia'
ALTER TABLE [dbo].[EmprendimientoEstadia]
ADD CONSTRAINT [PK_EmprendimientoEstadia]
    PRIMARY KEY CLUSTERED ([Id] ASC);
GO
...
-- Creating primary key on [Id] in table 'SubModuloSesionesProyecto'
...
-- Creating foreign key on [IdStatus] in table 'EmprendimientoEstadia'
ALTER TABLE [dbo].[EmprendimientoEstadia]
ADD CONSTRAINT [FK_EmprendimientoEstadia_Status]
    FOREIGN KEY ([IdStatus])
    REFERENCES [dbo].[Status]
        ([Id])
    ON DELETE NO ACTION ON UPDATE NO ACTION;
...
-- Creating non-clustered index for FOREIGN KEY 'FK_EmprendimientoEstadia_Status'
CREATE INDEX [IX_FK_EmprendimientoEstadia_Status]
ON [dbo].[EmprendimientoEstadia]
    ([IdStatus]);
GO

-- Creating foreign key on [IdCarrera] in table 'Estudiantes'
ALTER TABLE [dbo].[Estudiantes]
ADD CONSTRAINT [FK_Estudiantes_CatCarreras]
    FOREIGN KEY ([IdCarrera])
    REFERENCES [dbo].[CatCarreras]
        ([Id])
    ON DELETE NO ACTION ON UPDATE NO ACTION;
...
-- Creating non-clustered index for FOREIGN KEY 'FK_Estudiantes_CatCarreras'
CREATE INDEX [IX_FK_Estudiantes_CatCarreras]
ON [dbo].[Estudiantes]
    ([IdCarrera]);
GO

-- Creating foreign key on [IdCatGrupo] in table 'Estudiantes'
ALTER TABLE [dbo].[Estudiantes]
ADD CONSTRAINT [FK_Estudiantes_CatGrupos]
    FOREIGN KEY ([IdCatGrupo])
    REFERENCES [dbo].[CatGrupos]
        ([Id])
    ON DELETE NO ACTION ON UPDATE NO ACTION;
GO

-- Creating non-clustered index for FOREIGN KEY 'FK_Estudiantes_CatGrupos'
CREATE INDEX [IX_FK_Estudiantes_CatGrupos]
ON [dbo].[Estudiantes]
    ([IdCatGrupo]);
GO

-- Creating foreign key on [IdCatPeriodoEstadia] in table 'Estudiantes'
ALTER TABLE [dbo].[Estudiantes]
ADD CONSTRAINT [FK_Estudiantes_CatPeriodoEstadia1]
    FOREIGN KEY ([IdCatPeriodoEstadia])
    REFERENCES [dbo].[CatPeriodoEstadia]
        ([Id])
    ON DELETE NO ACTION ON UPDATE NO ACTION;
GO

-- Creating non-clustered index for FOREIGN KEY 'FK_Estudiantes_CatPeriodoEstadia1'
CREATE INDEX [IX_FK_Estudiantes_CatPeriodoEstadia1]
ON [dbo].[Estudiantes]
    ([IdCatPeriodoEstadia]);
GO

-- Creating foreign key on [IdEmprendimientoEstadia] in table 'Estudiantes'
ALTER TABLE [dbo].[Estudiantes]
ADD CONSTRAINT [FK_Estudiantes_EmprendimientoEstadia]
    FOREIGN KEY ([IdEmprendimientoEstadia])
    REFERENCES [dbo].[EmprendimientoEstadia]
        ([Id])
    ON DELETE NO ACTION ON UPDATE NO ACTION;
GO

-- Creating non-clustered index for FOREIGN KEY 'FK_Estudiantes_EmprendimientoEstadia'
CREATE INDEX [IX_FK_Estudiantes_EmprendimientoEstadia]
ON [dbo].[Estudiantes]
    ([IdEmprendimientoEstadia]);
GO

-- Creating foreign key on [IdTelefono] in table 'Estudiantes'
ALTER TABLE [dbo].[Estudiantes]
ADD CONSTRAINT [FK_Estudiantes_Telefonos]
    FOREIGN KEY ([IdTelefono])
    REFERENCES [dbo].[Telefonos]
        ([Id])
    ON DELETE NO ACTION ON UPDATE NO ACTION;
...
-- Creating non-clustered index for FOREIGN KEY 'FK_Estudiantes_Telefonos'
CREATE INDEX [IX_FK_Estudiantes_Telefonos]
ON [dbo].[Estudiantes]
    ([IdTelefono]);
GO

-- Creating foreign key on [IdStatus] in table 'Estudiantes'
ALTER TABLE [dbo].[Estudiantes]
ADD CONSTRAINT [FK_Estudiantes_Status]
    FOREIGN KEY ([IdStatus])
    REFERENCES [dbo].[Status]
        ([Id])
    ON DELETE NO ACTION ON UPDATE NO ACTION;
...
-- Creating non-clustered index for FOREIGN KEY 'FK_Estudiantes_Status'
CREATE INDEX [IX_FK_Estudiantes_Status]
ON [dbo].[Estudiantes]
    ([IdStatus]);
GO
...
-- Creating non-clustered index for FOREIGN KEY 'FK_SubModuloSesionesProyecto_Proyectos'
CREATE INDEX [IX_FK_SubModuloSesionesProyecto_Proyectos]
